    ...
    <header className="glass" style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', position: 'relative' }}>
            ...
            <div className="glass animated-fade-in" style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                {notifications.length === 0 ? (
                  <div style={{ padding: '24px', textAlign: 'center', color: 'var(--text-tertiary)', fontSize: '0.7rem' }}>No neural activity detected.</div>
                ) : notifications.map((n) => (
                  <div 
                    key={n.id} 
                    style={{ 
        ...
        <button 
          ...
          style={{ width: '28px', height: '28px', borderRadius: '0', background: 'var(--bg-tertiary)', border: '1px solid var(--border-subtle)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.65rem', fontWeight: 'bold', color: 'var(--brand-primary)', cursor: 'pointer' }}
        >
